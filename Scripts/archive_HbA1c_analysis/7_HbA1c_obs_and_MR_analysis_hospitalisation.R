...
##Bacterial
#Pneumonia
pneumonia_lr <- glm(pneumonia ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(pneumonia == 1 | control == 1)), family = "binomial")
#Skin infection
bacterial_skininfection_lr <- glm(bacterial_skininfection ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(bacterial_skininfection == 1 | control == 1)), family = "binomial")
#UTI
UTI_lr <- glm(UTI ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(UTI == 1 | control == 1)), family = "binomial")
#Cystitis
cystitis_lr <- glm(cystitis ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(cystitis == 1 | control == 1)), family = "binomial")
#Pyelonephritis
pyelonephritis_lr <- glm(pyelonephritis ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(pyelonephritis == 1 | control == 1)), family = "binomial")

##Viral
#Influenza
influenza_lr <- glm(influenza ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(influenza == 1 | control == 1)), family = "binomial")
#Other respiratory infection
otherrespiratoryinfection_lr <- glm(otherrespiratoryinfection ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(otherrespiratoryinfection == 1 | control == 1)), family = "binomial")
#Lower respiratory infection
lower_resp_lr <- glm(lower_resp ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(lower_resp == 1 | control == 1)), family = "binomial")
#Upper respiratory infection
upper_resp_lr <- glm(upper_resp ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(upper_resp == 1 | control == 1)), family = "binomial")

##Fungal
#Skin infection
fungal_skininfection_lr <- glm(fungal_skininfection ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(fungal_skininfection == 1 | control == 1)), family = "binomial")
#Genital infection
genitalinfection_lr <- glm(genitalinfection ~ hba1c + sex + recruit_age, data = (hba1c_obs_df %>% filter(genitalinfection == 1 | control == 1)), family = "binomial")
...
Obs_HbA1c <- Obs_HbA1c %>%
  mutate(case_when(
    Infection == "Pneumonia" ~ count(hba1c_obs_df %>% filter(pneumonia ==1)),
    Infection == "Bacterial skin infection" ~ count(hba1c_obs_df %>% filter(bacterial_skininfection ==1)),
    Infection == "UTI" ~ count(hba1c_obs_df %>% filter(UTI ==1)),
    Infection == "Cystitis" ~  count(hba1c_obs_df %>% filter(cystitis ==1)),
    Infection == "Pyelonephritis" ~  count(hba1c_obs_df %>% filter(pyelonephritis ==1)),
    Infection == "Influenza" ~  count(hba1c_obs_df %>% filter(influenza ==1)),
    Infection == "Other viral respiratory" ~  count(hba1c_obs_df %>% filter(otherrespiratoryinfection ==1)),
    Infection == "Lower respiratory" ~  count(hba1c_obs_df %>% filter(lower_resp ==1)),
    Infection == "Upper respiratory" ~  count(hba1c_obs_df %>% filter(upper_resp ==1)),
    Infection == "Fungal skin infection" ~  count(hba1c_obs_df %>% filter(fungal_skininfection ==1)),
    Infection == "Genital infection" ~  count(hba1c_obs_df %>% filter(genitalinfection ==1))
  )
  )
...
# Save table as CSV
write.csv(Obs_HbA1c, file = paste0("saveables/", "Obs_HbA1c_results_by_type.csv"), row.names=FALSE)
...
##Bacterial
#Pneumonia
pneumonia_gly <- glm(pneumonia ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(pneumonia == 1 | control == 1)), family = "binomial")
#Skin infection
bacterial_skininfection_gly <- glm(bacterial_skininfection ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(bacterial_skininfection == 1 | control == 1)), family = "binomial")
#UTI
UTI_gly <- glm(UTI ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(UTI == 1 | control == 1)), family = "binomial")
#Cystitis
cystitis_gly <- glm(cystitis ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(cystitis == 1 | control == 1)), family = "binomial")
#Pyelonephritis
pyelonephritis_gly <- glm(pyelonephritis ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(pyelonephritis == 1 | control == 1)), family = "binomial")

##Viral
#Influenza
influenza_gly <- glm(influenza ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(influenza == 1 | control == 1)), family = "binomial")
#Other respiratory infection
otherrespiratoryinfection_gly <- glm(otherrespiratoryinfection ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(otherrespiratoryinfection == 1 | control == 1)), family = "binomial")
#Lower respiratory infection
lower_resp_gly <- glm(lower_resp ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(lower_resp == 1 | control == 1)), family = "binomial")
#Upper respiratory infection
upper_resp_gly <- glm(upper_resp ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(upper_resp == 1 | control == 1)), family = "binomial")

##Fungal
#Skin infection
fungal_skininfection_gly <- glm(fungal_skininfection ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(fungal_skininfection == 1 | control == 1)), family = "binomial")
#Genital infection
genitalinfection_gly <- glm(genitalinfection ~ gly_pred + sex + recruit_age + gly_resid, data = (hba1c_gly %>% filter(genitalinfection == 1 | control == 1)), family = "binomial")
...
MR_gly_HbA1c <- MR_gly_HbA1c %>%
  mutate(case_when(
    Infection == "Pneumonia" ~ count(hba1c_gly %>% filter(pneumonia ==1)),
    Infection == "Bacterial skin infection" ~ count(hba1c_gly %>% filter(bacterial_skininfection ==1)),
    Infection == "UTI" ~ count(hba1c_gly %>% filter(UTI ==1)),
    Infection == "Cystitis" ~  count(hba1c_gly %>% filter(cystitis ==1)),
    Infection == "Pyelonephritis" ~  count(hba1c_gly %>% filter(pyelonephritis ==1)),
    Infection == "Influenza" ~  count(hba1c_gly %>% filter(influenza ==1)),
    Infection == "Other viral respiratory" ~  count(hba1c_gly %>% filter(otherrespiratoryinfection ==1)),
    Infection == "Lower respiratory" ~  count(hba1c_gly %>% filter(lower_resp ==1)),
    Infection == "Upper respiratory" ~  count(hba1c_gly %>% filter(upper_resp ==1)),
    Infection == "Fungal skin infection" ~  count(hba1c_gly %>% filter(fungal_skininfection ==1)),
    Infection == "Genital infection" ~  count(hba1c_gly %>% filter(genitalinfection ==1))
  )
  )
...
# Save table as CSV
write.csv(MR_gly_HbA1c, file = paste0("saveables/", "MR_gly_HbA1c_results_by_type.csv"), row.names=FALSE)
...
##Bacterial
#Pneumonia
pneumonia_non_gly <- glm(pneumonia ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(pneumonia == 1 | control == 1)), family = "binomial")
#Skin infection
bacterial_skininfection_non_gly <- glm(bacterial_skininfection ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(bacterial_skininfection == 1 | control == 1)), family = "binomial")
#UTI
UTI_non_gly <- glm(UTI ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(UTI == 1 | control == 1)), family = "binomial")
#Cystitis
cystitis_non_gly <- glm(cystitis ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(cystitis == 1 | control == 1)), family = "binomial")
#Pyelonephritis
pyelonephritis_non_gly <- glm(pyelonephritis ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(pyelonephritis == 1 | control == 1)), family = "binomial")

##Viral
#Influenza
influenza_non_gly <- glm(influenza ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(influenza == 1 | control == 1)), family = "binomial")
#Other respiratory infection
otherrespiratoryinfection_non_gly <- glm(otherrespiratoryinfection ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(otherrespiratoryinfection == 1 | control == 1)), family = "binomial")
#Lower respiratory infection
lower_resp_non_gly <- glm(lower_resp ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(lower_resp == 1 | control == 1)), family = "binomial")
#Upper respiratory infection
upper_resp_non_gly <- glm(upper_resp ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(upper_resp == 1 | control == 1)), family = "binomial")

##Fungal
#Skin infection
fungal_skininfection_non_gly <- glm(fungal_skininfection ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(fungal_skininfection == 1 | control == 1)), family = "binomial")
#Genital infection
genitalinfection_non_gly <- glm(genitalinfection ~ non_gly_pred + sex + recruit_age + non_gly_resid, data = (hba1c_non_gly %>% filter(genitalinfection == 1 | control == 1)), family = "binomial")
...
MR_non_gly_HbA1c <- MR_non_gly_HbA1c %>%
  mutate(case_when(
    Infection == "Pneumonia" ~ count(hba1c_non_gly %>% filter(pneumonia ==1)),
    Infection == "Bacterial skin infection" ~ count(hba1c_non_gly %>% filter(bacterial_skininfection ==1)),
    Infection == "UTI" ~ count(hba1c_non_gly %>% filter(UTI ==1)),
    Infection == "Cystitis" ~  count(hba1c_non_gly %>% filter(cystitis ==1)),
    Infection == "Pyelonephritis" ~  count(hba1c_non_gly %>% filter(pyelonephritis ==1)),
    Infection == "Influenza" ~  count(hba1c_non_gly %>% filter(influenza ==1)),
    Infection == "Other viral respiratory" ~  count(hba1c_non_gly %>% filter(otherrespiratoryinfection ==1)),
    Infection == "Lower respiratory" ~  count(hba1c_non_gly %>% filter(lower_resp ==1)),
    Infection == "Upper respiratory" ~  count(hba1c_non_gly %>% filter(upper_resp ==1)),
    Infection == "Fungal skin infection" ~  count(hba1c_non_gly %>% filter(fungal_skininfection ==1)),
    Infection == "Genital infection" ~  count(hba1c_non_gly %>% filter(genitalinfection ==1))
  )
  )
...
# Save table as CSV
write.csv(MR_non_gly_HbA1c, file = paste0("saveables/", "MR_non_gly_HbA1c_results_by_type.csv"), row.names=FALSE)
